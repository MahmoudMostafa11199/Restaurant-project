...
export const metadata = {
  title: 'About Us',
  description:
    'Discover our story, meet the people behind the magic, and learn why Kafika has become a favorite destination for food lovers. Welcome to a place where every bite feels like home!',
};
            ...
            <div className="col-12">
              ...
              <FramerAnimated direction="up">
                <p className="about-text">
                  Experience the epitome of culinary artistry at The Kafika,
                  where every dish is a masterpiece crafted with passion and
                  precision. Nestled in the heart of [City/Location], our
                  restaurant is a haven for food enthusiasts seeking
                  unparalleled dining experiences. From tantalizing appetizers
                  to exquisite mains and divine desserts, each creation reflects
                  our unwavering commitment to quality and innovation. Immerse
                  yourself in our warm and inviting ambiance, where every visit
                  promises to awaken your senses and leave lasting memories.
                  Join us at The Kafika and embark on a culinary journey that
                  celebrates the essence of excellence in every bite.
                </p>
              </FramerAnimated>
            </div>
