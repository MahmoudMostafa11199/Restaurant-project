...
import "../Services/DiscountSection.css";
    ...
    return (
        ...
        data-aos-duration="1200">
            <div className="container">
                <div className="row">
                    {/* Left Image */}
                    <div className="col-12 col-lg-3" style={{ paddingRight: "0px" }}>
                        <div className="card card-image-left">
                            <img src="/images/service/background-image-left.avif" alt="Food Item 1" />
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-lg-3">
                        <div className="card card-image-right">
                            <img src="/images/service/background-image-right.png" alt="Food Item 2" />
                        </div>
                    </div>
