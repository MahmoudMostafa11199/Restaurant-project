                ...
                <div className="row gx-2 gy-1">
                    ...
                    <div className="col-md-3 col-6">
                        <input
                            type="text"
                            name="name"
                            className={`name ${formik.errors.name && formik.touched.name ? "is-invalid" : ""}`}
                            placeholder="Person"
                    ...
                    <div className="col-md-3 col-6">
                        <input
                            type="date"
                            name="date"
                            className={`date ${formik.errors.date && formik.touched.date ? "is-invalid" : ""}`}
                    ...
                    <div className="col-md-3 col-6">
                        <input
                            type="time"
                            name="time"
                            className={`time ${formik.errors.time && formik.touched.time ? "is-invalid" : ""}`}
                            min="09:00"
                            max="24:00"
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
